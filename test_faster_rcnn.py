...
def evaluate(model, data_loader, device, ann_file):
    ...
    # Save detections
    with open(os.path.join(RESULTS_DIR, "faster_rcnn_test_predicts.json"), "w") as f:
    ...
    # Load detections
    coco_dt = coco_gt.loadRes(os.path.join(RESULTS_DIR, "faster_rcnn_test_predicts.json"))
